...
2. In a second terminal, start the tunnel: `bunx cloudflared tunnel --url http://localhost:4545`
3. Copy the tunnel URL and append `/mcp` (e.g., `https://random-name.trycloudflare.com/mcp`)
