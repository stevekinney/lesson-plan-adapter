...
- Zod v4: `import { z } from 'zod'` (`^4.0.0`)
...
- Import: `import { logger } from '@lesson-adapter/mcp/logger'`
...
- Never try to run Vitest in packages or bun test in the web application

## Linting & Formatting

- ESLint + Prettier: `bun turbo lint` to lint, `bun turbo format` to format
